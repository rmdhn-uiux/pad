...
class MahasiswaDashboard:
    ...
    def _build_tabs(self):
        ...
        tab_riwayat = ttk.Frame(notebook, padding=15)
    ...
    def _build_tab_absen(self, parent):
        ...
        self.label_info = ttk.Label(card, text="", font=("Helvetica", 10))
    ...
    def _refresh_status(self):
        ...
        if r.get('sudah_absen') and r.get('data'):
            data = r['data']
            self.label_status.config(text=f"Status: {data['status'].title()}",
